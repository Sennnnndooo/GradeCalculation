...
namespace GradeCalculationDataLogicLayer
{
    public class dl
    {
        public List<dm> grades = new List<dm>();
        ...
        public dm GetGrade(string studentName)
        {
            return grades.FirstOrDefault(g => g.StudentName == studentName);
        }
